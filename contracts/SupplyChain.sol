...
contract SupplyChain {
    ...
    mapping(uint32 => ownership) public ownerships; // ownership by owner_id
    ...
    function addProduct(
        ...
        // if statement can be replaced with 'require'
        if (
            keccak256(
    ...
    // requires the message sender to be the current product's owner
    ...
    // returns the product track (the list of participants who have owned a product)
    ...
    // returns the current owner of a particular product
